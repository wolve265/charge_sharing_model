...
class PixelChargeSharingModel2D:
    ...
    def __init__(
        ...
        # 1D Models
        self.x = PixelChargeSharingModel1D(
            pixel_size, num_of_charges, charge_cloud_sigma, noise_sigma
        )
        self.y = PixelChargeSharingModel1D(
            pixel_size, num_of_charges, charge_cloud_sigma, noise_sigma
        )
    ...
    def update_probabilities_1D(self) -> None:
        ...
        [0][1][2]
        """
        self.probs = probs = self.get_probabilities()
        self.x.probs = [
    ...
    def set_plt_axis_birds_eye_view(self, ax: plt.Axes, title: str) -> None:
        ax.set_title(title)
